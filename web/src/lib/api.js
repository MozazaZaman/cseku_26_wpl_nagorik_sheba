...
export const STATUS_META = {
  ...
  verified: { label: 'New · Junior Check', cls: 'bg-sky-500/15 text-sky-300 border-sky-400/30', dot: 'bg-sky-400' },
  junior_review: { label: 'Junior Check', cls: 'bg-sky-500/15 text-sky-300 border-sky-400/30', dot: 'bg-sky-400' },
  senior_review: { label: 'Senior Feasibility', cls: 'bg-violet-500/15 text-violet-300 border-violet-400/30', dot: 'bg-violet-400' },
  mayor_review: { label: 'Mayor Permission', cls: 'bg-violet-500/15 text-violet-300 border-violet-400/30', dot: 'bg-violet-400' },
  approved: { label: 'Mayor Approved', cls: 'bg-mint/15 text-mint border-mint/40', dot: 'bg-mint' },
  wit_review: { label: 'WIT Inspection', cls: 'bg-mint/15 text-mint border-mint/40', dot: 'bg-mint' },
  assigned: { label: 'Team Assigned', cls: 'bg-amber-500/15 text-amber-300 border-amber-400/30', dot: 'bg-amber-400' },
